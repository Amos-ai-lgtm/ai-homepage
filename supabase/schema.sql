...
-- ALTER ROLE "authenticator" WITH NOINHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:Zl19bn9RoK1jEVzggaCw8Q==$c62gQXvSuY+S47iBsYzj8PGhDTYWZ5XEuDC+h231PuI=:E6FyZ9KifMdnXryMr+mDUuyF8BS5jklV8OfN0I/KDWI=';
-- CREATE ROLE "dashboard_user";
-- ALTER ROLE "dashboard_user" WITH INHERIT CREATEROLE CREATEDB NOLOGIN REPLICATION NOBYPASSRLS;
-- CREATE ROLE "pgbouncer";
-- ALTER ROLE "pgbouncer" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:GN7RWUWDB2XrRXQ23Km1mw==$Cxp1ZLfA9578r1uCBiHwGze3HKBzoVqemssbeXSE6OQ=:Lv//DqBFhr7z30OgM+gCTi+33NpRb3PRp9kLoE6O4+M=';
-- CREATE ROLE "postgres";
-- ALTER ROLE "postgres" WITH INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:JH50ibo40c3MbtHI1yULEA==$Z/SlLWDVqDqPKa3BN62gUTjnrYlJK5wiQC7JfLlVcvM=:Q8Vsl6SvvW9On4Vchflg6L/adr9sI8q+L3BkWotZDf0=';
-- CREATE ROLE "service_role";
-- ALTER ROLE "service_role" WITH INHERIT NOCREATEROLE NOCREATEDB NOLOGIN BYPASSRLS;
-- CREATE ROLE "supabase_admin";
-- ALTER ROLE "supabase_admin" WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:CM8PEYr3tbKXJZ7W9xy3fw==$vt7K8ci6deW0JY0KTNxqWoim6tZzunS+Q7Jm5yV9zgM=:noD9AMOXrdZLvY1hyQvVJk6QHP+dt5e0NEUoYtlXCVE=';
-- CREATE ROLE "supabase_auth_admin";
-- ALTER ROLE "supabase_auth_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:eOYxeDV0JOHAq8aRz8MJtA==$R1NLljAoGKhQhjHNWYK1D9lVo44Px3jxuTrwh9dxUaU=:0XaX8E1JdfOcZZ7+HnAJ71IZ4rnpO6ay5cgqcQkSo5I=';
-- CREATE ROLE "supabase_functions_admin";
-- ALTER ROLE "supabase_functions_admin" WITH SUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:lYKs46EsVlMVMRwpy+NhTA==$lLXKIYAUniHF6R1MkHzoWANFMuh/UgC5EESPR50w6LM=:W1FsJ+AvoKiugs6PaY6iE9tgq4z1zEPSZehgxAxKjFI=';
...
-- ALTER ROLE "supabase_storage_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:GlWtjasrzEBD31HJCp2HGQ==$AcexHBT8cMVpHhxcS1Cta2OAfW9Sw6cfq7HWufj08eU=:e4wogE3PEwefsvY5TQZR/Eu5IvYs6aKc28R6dAX6h9A=';
...
--
-- Name: chat_messages anon_insert_messages; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: chat_messages anon_select_messages; Type: POLICY; Schema: public; Owner: -
--
