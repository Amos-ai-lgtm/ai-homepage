...
- **Endpoint**：`POST https://app-cdni0zi93ojl-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-cdni0zi93ojl-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
